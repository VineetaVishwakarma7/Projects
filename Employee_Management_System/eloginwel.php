<?php 
	...
	include_once ('process/model.php');
...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				<li><a class="homered" href="eloginwel?id=<?php echo $id?>"">HOME</a></li>
				<li><a class="homeblack" href="myprofile?id=<?php echo $id?>"">My Profile</a></li>
