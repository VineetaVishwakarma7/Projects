...
<body>
  <header>
    <nav>
      ...
      <ul id="navli">
        <li><a class="homeblack" href="eloginwel?id=<?php echo $id?>"">HOME</a></li>
        <li><a class="homered" href="myprofile?id=<?php echo $id?>"">My Profile</a></li>
        <li><a class="homeblack" href="elogin">Log Out</a></li>
      </ul>
    </nav>
  </header>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <button class="btn btn--radius btn--green" href = "#">Change Password</button>
                </div>
            </div>
        </div>
    </div>
